...
import {BLogType, CommentType, PostType, UserAccountDBType, UserDBType} from "../utils/types";
dotenv.config()
...
export const usersAccoutsCollection =  client.db('learning').collection<UserAccountDBType>('usersAccounts')
